...
package body Qoaconv is
   ...
   --  2 or 4 byte
   type U16_Buffer is array (Natural) of Unsigned_16;
   type U32_Buffer is array (Natural) of Unsigned_32;

   V    : qoa_uint64_t := 255_526;

   procedure Qoa_Write_U64
     (V : qoa_uint64_t; Bytes : access Unsigned_16; P : out U32_Buffer) 
   is
   begin
      --  Bytes (0) :=
      --    Unsigned_16(Shift_Right_Arithmetic (Unsigned_128(V), 56) and 16#FF#);
      null;
   end Qoa_Write_U64;
   ...
   function Qoa_Lms_Predict return Integer is
   begin
      return 0;
   end Qoa_Lms_Predict;

   function Qoa_Lms_Update return Integer is
   begin
      return 0;
   end Qoa_Lms_Update;

   function Qoa_Div return Integer is
   begin
      return 0;
   end Qoa_Div;
   ...
   function Qoa_Encode_Frame
     (Frame_Samples : Unsigned_16; Qoa_Desc : Qoa_Description;
      Frame_Len     : Unsigned_32; Bytes : Integer; Header : Unsigned_32)
      return Unsigned_32
   is
   begin
      return 0;
   ...
   function Qoa_Encode_Header
     (Qoa_Desc : Qoa_Description; Bytes : U16_Buffer) return Integer
   is
   begin
      return 0;
   ...
   begin
      ...
      for Sample_Index in 0 .. Qoa_Desc.Samples loop --when Frame_Len loop
         --Frame_Len     := Qoa_Clamp (Qoa_Frame_Len, 0, Qoa_Desc.Samples - Integer(Sample_Index));
